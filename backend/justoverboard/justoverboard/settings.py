"""
Django settings for justoverboard project.
...
SECRET_KEY = 'hp(rldal6z9sh@z2uf*r+bc&--swasz0fg377^=7v^(bde38zb'
...
ROOT_URLCONF = 'justoverboard.urls'
...
WSGI_APPLICATION = 'justoverboard.wsgi.application'
